...
public sealed class AiDocumentConfiguration : IEntityTypeConfiguration<AiDocument>
{
    public void Configure(EntityTypeBuilder<AiDocument> builder)
    {
        ...
        builder
            .Property(document => document.CollectionId)
        ...
        builder
            .Property(document => document.MetadataJson)
            .HasColumnName("metadata")
            .HasColumnType("jsonb")
            .IsRequired();

        builder
            .Property(document => document.ContentHash)
        ...
        builder.HasIndex(document => new { document.CollectionId, document.ContentHash });

        builder.HasIndex(document => document.Status);

        builder.HasIndex(document => document.MetadataJson).HasMethod("gin");
    }
}
